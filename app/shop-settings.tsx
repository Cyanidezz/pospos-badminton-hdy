...
export {settingsPayload} from '@/lib/settings-payload';
...
// Installs the 6-button rich menu (ติดตามงานขึ้นเอ็น / บัตรสมาชิก / โปรโมชั่น / ราคาขึ้นเอ็น / Facebook / โทร) on the shop's LINE OA. The link and
...
export function LineMenuPanel({config,lineReady,Field,onDone}:any){
  ...
  return <div className="panel report line-menu-panel"><h2>เมนูบน LINE OA (Rich menu)</h2>
    <p className="muted">เมนู 6 ปุ่มด้านล่างแชท LINE ของร้าน: ติดตามงานขึ้นเอ็น, บัตรสมาชิก (สมัครสมาชิก / ดาวสะสม), โปรโมชั่น, ราคาขึ้นเอ็น, Facebook ร้าน และโทรหาร้าน · กดติดตั้งซ้ำเมื่อเปลี่ยนเมนู</p>
